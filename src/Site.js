    ...
    <div className="container">
      ...
      <main>
        <div className="hello-text">
          ...
          <a className="cv-link" href="https://docs.google.com/document/d/1Jtz-lmaFES7IfLbaUEjr84oWEab9kuHve5m7a8o49-0/edit?usp=sharing" title="Google Docs | CV" target="_blanc">CV</a>
        </div>
